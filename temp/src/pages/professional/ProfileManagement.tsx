...
import { User, Mail, Phone, MapPin, Briefcase, Award, Upload, Save, Plus } from 'lucide-react';
...
const ProfileManagement: React.FC = () => {
  ...
  const [formData, setFormData] = useState({
    ...
    bio: 'Professional plumber with 15 years of experience in residential and commercial plumbing services. Specializing in repairs, installations, and maintenance.',
  ...
  const handleAddCertification = () => {
    if (formData.newCertification.trim() === '') return;
    setFormData(prev => ({
      ...prev,
